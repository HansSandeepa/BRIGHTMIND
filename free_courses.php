...
<head>
    ...
    <link rel="stylesheet" href="./css/free_courses.css">
</head>
                ...
                <div id="courseTitleContainer">
                    ...
                    <div>
                        ...
                        <p id="courseDescription">
                            This course introduces financial markets, covering stocks,
                            <br>
                            bonds, derivatives, and investment strategies.
                            <br>
                            Perfect for beginners, it helps you analyze trends, make informed decisions,
                            <br>
                            and manage risks effectively.
                        </p>
                        <button id="enrollBtn" onclick="location.href='./login.html'">
                    ...
                    <div>
                        <img src="./assets/courses/banalyze.jpeg" alt="course image" id="courseImage">
                    </div>
                </div>
